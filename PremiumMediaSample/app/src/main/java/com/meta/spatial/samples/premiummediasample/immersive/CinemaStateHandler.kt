...
class CinemaStateHandler(private val immersiveViewModel: ImmersiveViewModel) {
    ...
    fun setCinemaState(
        ...
        // CORRECTED FOR EXOPlayer 2.14 API
        val isPlaying =
            forceIsPlayingLighting
                ?: (immersiveViewModel.exoPlayer.isPlaying() || // Changed to method call
                        immersiveViewModel.exoPlayer.getPlayWhenReady()) // Changed to method call
